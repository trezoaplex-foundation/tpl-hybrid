...
pub struct UpdateNewDataV1 {
    pub nft_data: trezoa_program::pubkey::Pubkey,
...
itpl UpdateNewDataV1InstructionData {
    pub fn new() -> Self {
        Self {
...
pub struct UpdateNewDataV1Builder {
    nft_data: Option<trezoa_program::pubkey::Pubkey>,
...
itpl UpdateNewDataV1Builder {
    pub fn new() -> Self {
        Self::default()
    }
    #[inline(always)]
    pub fn nft_data(&mut self, nft_data: trezoa_program::pubkey::Pubkey) -> &mut Self {
...
pub struct UpdateNewDataV1CpiAccounts<'a, 'b> {
    pub nft_data: &'b trezoa_program::account_info::AccountInfo<'a>,
...
itpl<'a, 'b> UpdateNewDataV1Cpi<'a, 'b> {
    pub fn new(
...
itpl<'a, 'b> UpdateNewDataV1CpiBuilder<'a, 'b> {
    ...
    pub fn nft_data(
        &mut self,
        nft_data: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct UpdateNewDataV1CpiBuilderInstruction<'a, 'b> {
    ...
    nft_data: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
