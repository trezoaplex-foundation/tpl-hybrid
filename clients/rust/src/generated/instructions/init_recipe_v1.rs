...
pub struct InitRecipeV1 {
    ...
    pub fee_location: trezoa_program::pubkey::Pubkey,
    /// The ATA for token fees to be stored
    pub fee_ata: trezoa_program::pubkey::Pubkey,
...
itpl InitRecipeV1InstructionData {
    pub fn new() -> Self {
        Self {
...
pub struct InitRecipeV1Builder {
    ...
    fee_location: Option<trezoa_program::pubkey::Pubkey>,
    fee_ata: Option<trezoa_program::pubkey::Pubkey>,
...
itpl InitRecipeV1Builder {
    ...
    #[inline(always)]
    pub fn fee_location(&mut self, fee_location: trezoa_program::pubkey::Pubkey) -> &mut Self {
        self.fee_location = Some(fee_location);
        self
    }
    /// The ATA for token fees to be stored
    #[inline(always)]
    pub fn fee_ata(&mut self, fee_ata: trezoa_program::pubkey::Pubkey) -> &mut Self {
...
pub struct InitRecipeV1CpiAccounts<'a, 'b> {
    ...
    pub fee_location: &'b trezoa_program::account_info::AccountInfo<'a>,
    /// The ATA for token fees to be stored
    pub fee_ata: &'b trezoa_program::account_info::AccountInfo<'a>,
...
itpl<'a, 'b> InitRecipeV1CpiBuilder<'a, 'b> {
    ...
    pub fn fee_location(
        &mut self,
        fee_location: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn fee_ata(
        &mut self,
        fee_ata: &'b trezoa_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
...
struct InitRecipeV1CpiBuilderInstruction<'a, 'b> {
    ...
    fee_location: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
    fee_ata: Option<&'b trezoa_program::account_info::AccountInfo<'a>>,
